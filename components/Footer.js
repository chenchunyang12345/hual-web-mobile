    ...
    return (
      <div className={styles.footer}>
        ...
        <p className={styles.introduce_text}>
          ...
          <a href="http://www.beian.miit.gov.cn" target="_blank" className={styles.gov}>京ICP备19007763</a>
        </p>
        <div className={styles.explain}>
          <div className={styles.core}>
            <p className={styles.headline}>核心技术</p>
            <div className={styles.content}>
              <Link href={`${process.env.path.nav2}#t1`}>
                <a className={styles.subhead}>智能语音平台</a>
              </Link>
              <Link href={`${process.env.path.nav2}#t2`}>
                <a className={styles.subhead}>企业知识图片构建</a>
              </Link>
          ...
          <div className={styles.core}>
            <p className={styles.headline}>产品与服务</p>
            <div className={styles.content}>
        ...
        <div className={styles.contact}>
          <p className={styles.headline}>联系我们</p>
